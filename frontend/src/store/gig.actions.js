...
import { ADD_GIG, ADD_TO_GIGT, CLEAR_GIGT, REMOVE_GIG, REMOVE_FROM_GIGT, SET_GIGS, UNDO_REMOVE_GIG, UPDATE_GIG } from "./gig.reducer.js";
...
export async function checkout(total) {
    try {
        ...
        store.dispatch({ type: CLEAR_GIGT })
        return score
    } catch (err) {
