    ...
    return (
        <div className={detailsReviews ? "review-preview-details" : "review-preview"}>
            <div className="reviewer flex">
                <div className="reviewer-img reviewer-item "><img src={review.imgUrl} /></div>
                {/* <div className="reviewer-name reviewer-item">{review.by.name}</div> */}
                <div className="review-content flex">{detailsReviews && <div className="nickname-review flex column"> <div className="reviewer-name reviewer-item ">{review.name}</div>
                    {/* <div className="reviewer-location reviewer-item">🏳️‍⚧️ Usa </div> */}
                    <div className="reviewer-location reviewer-item flex"><img src={review.flag} />
                        <span className=" reviewer-location-country"> {review.country}</span> </div><div className="review-date">{review.reviewedAt}</div></div> ||
                    <div className="nickname-review flex"><div className="reviewer-name reviewer-item ">{review.name}</div>
                        {/* <div className="reviewer-location reviewer-item">🏳️‍⚧️ Usa </div> */}
                        <div className="reviewer-location reviewer-item flex"><img src={review.flag} />
            ...
            <div className="reviewer-content flex ">
                <div className="review-msg">
                    ...
                    {/* <div>{review.txt}</div> */}
                    {!detailsReviews && <div className="review-date">{review.reviewedAt}</div>}
