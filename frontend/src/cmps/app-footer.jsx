...
export function AppFooter() {
  ...
  return (
    <footer className="app-footer main-layout full align-center  ">
      <section className="footer-container flex align-center space-between ">
        <div className="title">
          <h1 className="logo-footer">Fiverr.</h1>
          <p className="copy-rights">© Fiverr International Ltd. 2023</p>
        </div>
...
//   {isGigtShown && gigt.length > 0 && (
//     <section className="gigt">
//       <h5>Your Gigt</h5>
//       <ul>
//         {gigt.map((gig, idx) => (
//           <li key={idx}>
