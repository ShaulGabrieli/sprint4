    ...
    return (
        <header className='app-header main-container full sticky'>
            <div className='flex space-between align-center'>
                ...
                <a href=''>
                    <img src='https://fiverr-res.cloudinary.com/npm-assets/layout-server/bell.78d6546.svg' class='notifications-drawer-bell-trigger' alt='Notifications'></img>
                </a>
                <a href=''>
                    <img src='https://fiverr-res.cloudinary.com/npm-assets/layout-server/letter.07c989b.svg' class='notifications-drawer-letter-trigger' alt='Messages'></img>
                </a>
                <a href=''>
